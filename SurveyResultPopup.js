...
import '../../containers/survey/surveyStyles.scss';
...
import MatrixPreviewTable from '../../containers/survey/MatrixPreviewTable';
...
class SurveyResultPopup extends Component {
    ...
    componentDidMount(){
        console.log('reached',this.props.data.sguid);
        const {location} = this.props
        if(this.props.data.sguid){
            this.setState({loading: 1});
            new Api(GetAPIHeader(Storage.getAccessToken())).v31.getSurveyGraphReport(this.props.data.sguid)
                .then(response => {
                ...
                {eachQuestion.multipleChoice.values.map((eachChoice, index) => {
                    ...
                    return (
                        <div className="row d-flex">
                            ...
                            <div className="col-1 border-right ml-xl-n2"></div>
                            <div className="col-7 px-0 mb-3 ml-n1">
                            ...
                            <div className="col-1 ml-n1 mb-3">
                                <div className="small"
                            ...
                            <div className="bar-chart mr-n1">
                                ...
                                <div>
                                    <div className={ratingType === 2 ?
                                        ...
                                        "mr-xl-3 mr-lg-3 mr-md-3 mr-sm-3 mr-0 survey-verical-large-barchat my-2 rounded-lg"}
                                        style={{
                                            height:
    ...
    render() {
        ...
        const {show,closePopup,t} = this.props;
...
export default withTranslation('translation')(withRouter(SurveyResultPopup));